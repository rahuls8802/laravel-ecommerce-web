    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            ...
            <div class="wrap-iten-in-cart">
                {{-- checking if session has success message --}}
                @if (Session::has('success_message'))
                    <div class="alert alert-success"><strong>Success</strong>{{ Session::get('success_message') }}
                    </div>
                @endif
                {{-- checking if cart has product or not where count() is greater than 0 --}}
                @if (Cart::count() > 0)

                    <h3 class="box-title">Products Name</h3>
                    <ul class="products-cart">
                        {{-- adding foreach loop for looping cart's product added in cart --}}
